# Generated by Django 2.1.3 on 2019-02-12 21:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fuel_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vehicles.Vehicle_Fuel')),
            ],
            options={
                'ordering': ['fuel_id', 'pos'],
            },
        ),
        migrations.CreateModel(
            name='Vehicle_Type',
        ...
        migrations.AddField(
            ...
            name='type',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='vehicles.Vehicle_Type'),
        ),
        migrations.AlterUniqueTogether(
            name='vehicle_fuel_pos',
